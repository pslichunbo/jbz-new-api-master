...
public class SmsUtil {
    ...
    public static SendSmsResponse sendSms(String code, String mobile) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("机帮主");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_151800047");
    ...
    public static String Send(String phone) throws ClientException, InterruptedException {
        //发短信
        String sms = getSix();
        SendSmsResponse response = sendSms(sms,phone);
